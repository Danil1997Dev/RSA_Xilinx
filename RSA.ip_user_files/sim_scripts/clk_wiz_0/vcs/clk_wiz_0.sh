...
#
# Generated by Vivado on Sat Sep 24 17:11:13 +0800 2022
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../RSA.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../RSA.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/d:/XilinxFPGA/RSA/RSA.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
